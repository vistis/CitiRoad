...
<body class="bg-gray-100 font-sans"> {{-- Added font-sans for consistency --}}
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6 bg-gray-50 overflow-y-auto">
            ...
            {{-- The current pagination uses JavaScript which won't work directly with the server-side form submission.
                 For full server-side pagination, your controller's `readAll` method would need to use `->paginate()`
                 and you would render `$reports->links()` here.
            --}}
