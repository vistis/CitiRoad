...
<body class="bg-gray-100 font-sans">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6 bg-gray-50 overflow-y-auto">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Administrators</h1>
            </div>
            ...
            <div id="adminCards" class="space-y-2 rounded-lg shadow-md overflow-hidden">
                @forelse($admins as $admin) {{-- Loop through the admins data --}}
